...
Status: aprovado e integrado à `main` em 12 de agosto de 2026. Providers,
sandbox, callbacks públicos, credenciais, release e deploy continuam
desabilitados e dependem de autorizações próprias.
