...
def can_view_fulfillments(*, user, organization):
    return membership_for(user=user, organization=organization) is not None


def can_operate_fulfillments(*, user, organization):
    return membership_for(user=user, organization=organization) is not None


def can_cancel_fulfillments(*, user, organization):
...
def can_view_unmasked_personal_data(*, user, organization):
    return can_cancel_fulfillments(user=user, organization=organization)
